...
const Test = () => {
  ...
  // const list = ("https://6cw4vl6ty7.execute-api.ap-northeast-1.amazonaws.com/dev");
   
    // const [blogCount, setBlogCount] = useState(list.length);
  ...
  return (
    ...
    {/* <div className="container">  */}
      ...
      <div className="snap">
      <div style={{ display: "flex", alignItems: "center" }} className="search-nav">
